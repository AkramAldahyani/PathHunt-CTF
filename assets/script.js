...
const _base = (() => {
  ...
  const cur =
    ...
    Array.from(document.getElementsByTagName("script")).find(
      (s) => s.src && /assets\/script\.js/.test(s.src),
    );
  if (cur && cur.src) {
...
const PATHHUNT = {
  challenges: [
    ...
    {
      id: 2,
      slug: "hidden-entry-9xA",
      name: "CSS Leak",
      difficulty: 1,
      points: 100,
      path: "hidden-entry-9xA.html",
    ...
    },
    {
      id: 3,
      slug: "js-vault-3kL",
      name: "Base64 JavaScript",
      difficulty: 2,
      points: 150,
      path: "js-vault-3kL.html",
    ...
    },
    {
      id: 9,
      slug: "login-gate",
      name: "Client-side Login Bypass",
      difficulty: 4,
      points: 250,
      path: "login-gate.html",
...
function resetProgress() {
  if (!confirm("Reset all progress? This clears solved flags and your score."))
    return;
